...
const UploadCompanyManagementDoc = async (arg) => {
    ...
    const config = {
        ...
        data: {
            query: `
        mutation {
            updateProjectDoc(companyManagement: "${arg}")
            }
            `
        }
    }
...
const UploadCompanyManagement = () => {
    ...
    const getDocs = async () => {
        ...
        if (req.data.data !== null) {
            await setDoc(req.data.data.getProjectDocById.companyManagement);
    ...
    const onDrop = useCallback((acceptedFiles) => {
        acceptedFiles.forEach(async (acceptedFile) => {
            ...
            UploadCompanyManagementDoc(res);
            setIsDropped(true);
        });
    }, []);
    ...
    return (
        <div className={style.card} {...getRootProps()}>
            <h3>Organisation de l'entreprise</h3>
...
export default UploadCompanyManagement;