...
const updateManagement = async (arg) => {
    ...
    const config = {
        ...
        data: {
            query: `
            mutation{
                updateProjectDoc(managementLink:"${arg}")
            }
        `
        }
    };
...
const UploadManagementCard = ({ managementLink }) => {
    ...
    const getDocs = async () => {
        ...
        if (req.data.data !== null) {
            setDocs(req.data.data.getProjectDocById.managementLink);
        }
    }
...
export default UploadManagementCard;